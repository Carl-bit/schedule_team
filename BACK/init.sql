...
CREATE TABLE registro_horas (
    ...
    -- NULL mientras trabaja
    estado_id INTEGER DEFAULT 1,
    -- Por defecto 'Generado/Pendiente'
    FOREIGN KEY (empleado_id) REFERENCES empleados(empleado_id),
